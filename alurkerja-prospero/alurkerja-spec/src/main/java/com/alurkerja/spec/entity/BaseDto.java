...
@Getter
@Setter
public abstract class BaseDto<E, D> implements Serializable {
    private Long id;
    ...
    public List<Predicate> createCustomPredicate(Root<E> root, CriteriaQuery<E> query, CriteriaBuilder builder, List<Object> list) {
        return null;
    }
